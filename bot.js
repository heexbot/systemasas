...
client.on("message", message => {
	var prefix = "PERFIX CHANGER";
 if (message.content === "PERFIX CHANGERhelp**)(") {
...
client.on('message', message => {
    if (message.content === "PERFIX CHANGERhelp-p") {
...
client.on('message', message => {
    if (message.content === "PERFIX CHANGERhelp-a") {
    let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#000000")
  .addField("Done | تــــم" , ":envelope: | :sleuth_or_spy::skin-tone-3:شيك علي في الخاص")
  ...
  client.on('message', message => {
    if (message.content === "PERFIX CHANGERhelp-g") {
    let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#000000")
  .addField("Done | تــــم" , ":envelope: | :sleuth_or_spy::skin-tone-3:شيك علي في الخاص")
  ...
  client.on('message', message => {
    if (message.content === "PERFIX CHANGERhelp-m") {
    let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#000000")
  .addField("Done | تــــم" , ":envelope: | :sleuth_or_spy::skin-tone-3:شيك علي في الخاص")
  ...
  message.channel.sendEmbed(embed);
   ...
   client.on("message", message => {
    if (message.content === "PERFIX CHANGERhelp--1") {
     const embed = new Discord.RichEmbed() 
...
**============ **
  ** PERFIX CHANGERmove @user |  لسحب الشخص الى روومك** :confused: 

  ** PERFIX CHANGERbc | رسالة جماعية الى كل اعضاء السيرفر** :mega:

  ** PERFIX CHANGERrole @user <rank> | لأعطاء رتبة لعضو معين**:large_orange_diamond: 

  ** PERFIX CHANGERroleremove @user <rank> | لازالة الرتبة من شخص معين** :orange_book: 

  ** PERFIX CHANGERrole all <rank> | لأعطاء رتبة للجميع**:shield: 

  ** PERFIX CHANGERrole humans <rank> | لأعطاء رتبة للاشخاص فقط **:man: , :woman: 

  **PERFIX CHANGERrole bots <rank> | لأعطاء رتبة لجميع البوتات**:robot: 

  ** PERFIX CHANGERschannel | اضهار الشات المخفية**:blush: 

  ** PERFIX CHANGERhchannel | اخفاء الشات**:arrow_heading_down: 

  ** PERFIX CHANGERclr <numbr> | مسح الشات بعدد**:information_source: 

  ** PERFIX CHANGERclear | مسح الشات ** :recycle: 

  ** PERFIX CHANGERmute @user <reason> | اعطاء العضو ميوت لازم رتبة <Muted>**:mute:

  ** PERFIX CHANGERunmute @user | لفك الميوت عن الشخص ** :loud_sound:

  ** PERFIX CHANGERkick @user <reason> | طرد الشخص من السيرفر**  :outbox_tray:

  ** PERFIX CHANGERban @user <reason> | حضر الشخص من السيرفر** :no_entry:

  ** PERFIX CHANGERmutechannel | تقفيل الشات**:no_entry:

  ** PERFIX CHANGERunmutechannel | فتح الشات**:on:   

  ** PERFIX CHANGERdc | مسح كل الرومات**

  ** PERFIX CHANGERdr | <مسح كل الرانكات <لازم تكون رانك البوت فوق كل الرانكات**

  ** PERFIX CHANGERct <name> | انشاء شات**:rolling_eyes:

  ** PERFIX CHANGERcv <name> | انشاء رووم فويس**:crown:

  ** PERFIX CHANGERdelet <name> | مسح الشات او الرووم فويس**

  ** PERFIX CHANGERccolors <number> | ينشا لك الوان مع كم الوان تبي**
...
`)
  ...
  ** PERFIX CHANGERrps | حجر ورقة مقص ** :video_game:

  ** PERFIX CHANGERspeed | اسرع كتابن ** :video_game:

  ** PERFIX CHANGERquas | اسئلة عامة ** :video_game:

  ** PERFIX CHANGERنكت | نكت ** :video_game:

  ** PERFIX CHANGERلعبة فكك | فكك ** :video_game:

  ** PERFIX CHANGERلعبة عواصم | عواصم** :video_game:

  ** PERFIX CHANGERلعبة كت تويت | كت تويت ** :video_game:

  ** PERFIX CHANGERroll | قرعة راندوم** :video_game:

  ** PERFIX CHANGERلو خيروك بطريقة حلوة | لوخيروك

  ** PERFIX CHANGERلعبة مريم | مريم** :video_game: 
  
  ** PERFIX CHANGERفوائد نصائح | هلتعلم ** :video_game: 
  
  ** PERFIX CHANGERيعطيك عقابات قاسية |عقاب** :video_game: 
   `)
   message.author.sendEmbed(embed)
  ...
  ** PERFIX CHANGERplay | لتشغيل اغنية برابط او بأسم** 

  ** PERFIX CHANGERskip | لتجآوز الأغنية الحآلية**

  ** PERFIX CHANGERpause | إيقآف الأغنية مؤقتا**

  ** PERFIX CHANGERresume | ل**موآصلة الإغنية بعد إيقآفهآ مؤقتا

  ** PERFIX CHANGERvol | لتغيير درجة الصوت 100 - 0**

  ** PERFIX CHANGERstop | لإخرآج البوت من الروم**

  ** PERFIX CHANGERnp | لمعرفة الأغنية المشغلة حآليا**

  ** PERFIX CHANGERqueue | لمعرفة قآئمة التشغيل**
...
**============ **
  ...
  ** PERFIX CHANGERallbots | لعرض جميع البوتات الي بالسيرفر** :robot: 

  ** PERFIX CHANGERserver |يعرض لك معلومات عن السيرفر**:fire: 

  ** PERFIX CHANGERbot | يعرض لك كل معلومات البوت**:computer: 
  
  ** PERFIX CHANGERskin <name> | يعرض لك سكنك بماين كرافت**:blush:

  ** PERFIX CHANGERcount | يعرض لك عدد الاشخاص بالسيرفر بدون بوتات** :information_source:

  ** PERFIX CHANGERinvites | يعرض لك  عدد انفايتاتك بالسيرفر ** :microscope: 

  ** PERFIX CHANGERinvite-codes | يعرض لك روابط الانفايتات حكك في السيرفر **:spy: 

  ** PERFIX CHANGERcal | اله حاسبة**:slot_machine: 

  ** PERFIX CHANGERtrans <language> <any thing> | يترجم لك الي تبيه من اي لغة**:writing_hand: 

  ** PERFIX CHANGERshort | يختصر لك رابط كبير الى رابط صغير**:mortar_board: 

  ** PERFIX CHANGERtag | يكتب لك الكلمة بشكل جميل وكبير**:sunglasses: 

  ** PERFIX CHANGERgoogle | للبحث في قوقل عن طريق الدسكورد**:desktop: 

  ** PERFIX CHANGERperms | يعرض لك برمشناتك بالسيرفر**:pushpin: 

  ** PERFIX CHANGERza5 | يزخرف لك كلمة او جملة**:hearts: 

  ** PERFIX CHANGERrooms | يعرض لك كل الرومات الي بالسيرفر مع عددها**:rocket: 

  ** PERFIX CHANGERroles | يعرض لك كل الرانكات بالسيرفر بشكل جميل**

  ** PERFIX CHANGERemojilist | يعرض لك كل الايموجيات الي بالسيرفر**:cry: :smile: :joy: 

  ** PERFIX CHANGERsay | يكرر الكلام الي تكتبو**:sparkles: 

  ** PERFIX CHANGERimage | صورة السيرفر**:bust_in_silhouette: 

  ** PERFIX CHANGERmembers | يعرض لك عدد كل حالات الاشخاص وعدد البوتات وعدد الاشخاص**:selfie: 

  ** PERFIX CHANGERprofile | ليعرض البرفايل حقك** 

  ** PERFIX CHANGERbans | عدد الاشخاص المبندة **:no_entry: 

  ** PERFIX CHANGERavatar | صورتك او صورة الي تمنشنو**:bust_in_silhouette:

  ** PERFIX CHANGERembed | يكرر الي تقولو بشكل حلو**:small_blue_diamond: 

  ** PERFIX CHANGERemoji <any things> | لتحويل اي كلمه تقولها الي ايموجي**:small_orange_diamond: 

  ** PERFIX CHANGERinv | لدعوة البوت الى سيرفرك**:black_circle: 

  ** PERFIX CHANGERsupport | سيرفر الدعم**:wrench:  :envelope_with_arrow: 
  
  ** PERFIX CHANGERcontact | ارسال اقتراح او لمراسلة صاحب البوت**
...
const adminprefix = "PERFIX CHANGER";
...
client.on('message', message => {
 if (message.content.startsWith("PERFIX CHANGERعقاب")) {
...
'*** انا لست الحوت الازرق كما يدعون ***',
 ...
 client.on('message', message => {
 if (message.content.startsWith('PERFIX CHANGERمريم')) {
...
if (message.content.startsWith(prefix + 'trans')) {
    ...
    if (!args[0]) {
        ...
        const embed = new Discord.RichEmbed()
            .setColor("FFFFFF")
            .setDescription("**ترجمة الكتابة.**\استعمل: `PERFIX CHANGERtranslate <الكلمة لتبي> <االغة>`");
        ...
        if (args.length === undefined) {
            ...
            return message.channel.send("**ترجمة الكتابة.**\استعمل: `PERFIX CHANGERtranslate <الكلمة لتبي> <االغة>`");
...
if (message.content.startsWith('PERFIX CHANGERlegend')){
...
client.on('message', message => {
    if (message.content.startsWith("PERFIX CHANGERbot")) {
    message.channel.send({
...
message.react("❌")
 ...
 client.on('message', message => {
              if (!message.channel.guild) return;
      if(message.content =='PERFIX CHANGERcount')
...
if (!points[message.author.id]) points[message.author.id] = {
  ...
  if(!message.guild) return;
    let id = message.author.id,prefix="PERFIX CHANGER";
...
client.on('ready', function(){	
    var ms = 40000 ;	
    var setGame = ['PERFIX CHANGERinv','PERFIX CHANGERhelp'];	
    var i = -1;	
    var j = 0;	
    setInterval(function (){	
        if( i == -1 ){	
...
client.on('message', message => {
    if (message.content === "PERFIX CHANGERrooms") {
        if (message.author.bot) return
                      if (!message.guild) return;
...
client.on('message', message =>{
    ...
    if(message.content == "PERFIX CHANGERroles"){
        var 
...
client.on('message', message => {
    if (message.content == "PERFIX CHANGERquas") {
         message.react('🤔','👌')
...
client.on('message', message => {
    if(!message.guild) return;
    if (message.author.bot) return;
      let id = message.author.id,prefix="PERFIX CHANGER";//البريفكس
...
client.on('message', message => {
    if (message.content.startsWith("PERFIX CHANGERbans")) {
...
client.on('message', message => {
        if (message.content === "PERFIX CHANGERinv") {
            if(!message.channel.guild) return;
        let embed = new Discord.RichEmbed()
        .setAuthor(` ${message.author.username} `, message.author.avatarURL)      
...
client.on('message', message => {
    if (message.content.startsWith("PERFIX CHANGERavatar")) {
if(!message.channel.guild) return;
...
message.channel.stopTyping()
   ...
   client.on('message', message => {
     if (message.content === "PERFIX CHANGERsupport") {
     let embed = new Discord.RichEmbed()
  .setAuthor(message.author.username)
  .setColor("#9B59B6")
...
client.on("message", (message) => {
if (message.content.startsWith("PERFIX CHANGERct")) {
...
client.on("message", (message) => {
if (message.content.startsWith("PERFIX CHANGERcv")) {
            if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
        let args = message.content.split(" ").slice(1);
...
Server owner: __${guild.owner}__**`)
			      ...
			      client.on("message", (message) => {
    if (message.content.startsWith('PERFIX CHANGERdelet')) {
        if (!message.member.hasPermission('MANAGE_CHANNELS')) return message.reply("You Don't Have `MANAGE_CHANNELS` Premissions ");
