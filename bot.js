...
**  ======:blossom:نــتــمــنــآ لــكــم آســتــمـــتــآع :blossom:======  **`)
 ...
 .setTitle(`Welcome To ${msg.guild.name}`)
  ...
  .setURL('https://discordapp.com/oauth2/authorize?client_id=487662874504724481&permissions=8&scope=bot')
...
client.on('message', message => {
        ...
        .setURL(`https://discordapp.com/api/oauth2/authorize?client_id=487662874504724481&permissions=8&scope=bot`)
...
let profile = JSON.parse(fs.readFileSync("creditsCode.json", "utf8"))
client.on("message", message => {
...
if(message.content.startsWith(prefix + "daily")) {
  if(profile[message.author.id].lastDaily != moment().format('day')) {
    ...
    profile[message.author.id].credits += 200000000000000000000000000000
...
const sWlc = {}
const premium = ['323888904602124299', '', '', '']
client.on('message', message => {
var prefix = "-";
                  ...
                  ctx.drawImage(ground, 0, 0, 540, 230);
                      ...
                      jimp.read(url, (err, ava) => {
                          ...
                          ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                              ...
                              ctx.fontSize = '150px';
                              ctx.fillStyle = "#FFFFFF";
      ctx.fillText(`Welcome To ${member.guild.name}`, 1200, 900);
